...
ImaxA = 0.550 , # Maximum growth rates of autotrophs
ImaxH = 0.550 , # Maximum growth rates of heterotrophs
...
Y_A = 0.060 , #BGE of autotrophs (Yield)
Y_H = 0.060 , #BGE oh heterotrophs (Yield)
